    ...
    <footer className="bg-secondary text-secondary-foreground w-full pt-20 pb-8 relative">
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-sm items-start text-center md:text-left">
          ...
          <div>
             <h3 className="font-semibold text-lg mb-4 text-white">Useful Links</h3>
            ...
            <div className="flex items-center justify-center gap-4">
                <Button variant="ghost" size="icon" asChild>
                  <Link href="#" aria-label="LinkedIn">
                    <Linkedin className="h-6 w-6 text-white hover:text-primary-foreground" />
                  </Link>
                </Button>
                <Button variant="ghost" size="icon" asChild>
                  <Link href="mailto:example@example.com" aria-label="Email">
                    <Mail className="h-6 w-6 text-white hover:text-primary-foreground" />
                  </Link>
                </Button>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <p className="text-white order-last md:order-first">
          ...
          <div className="flex items-center gap-2 order-first md:order-last text-center">
            <p className="text-white">Designed & Managed by Tanish sunita pareek</p>
          </div>
        </div>
      </div>
    </footer>
